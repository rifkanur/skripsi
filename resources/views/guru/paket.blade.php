...
<div class="content">
  ...
  <!-- End Presentation -->
 <!-- //////////////////////////////////////////////////////////////////////////// -->
 <form action="/insertpaketsoal" method="post">
    @csrf
    <div class="form-group row">
      <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Paket Soal</label>
      <div class="col-sm-10">
        <input type="text" name="Nama_Paket_Soal" class="form-control" id="inputEmail3" placeholder="id Paket soal">
      </div>
    </div>
    <div class="form-group row">
      <label for="inputPassword3" class="col-sm-2 col-form-label">Mata Pelajaran</label>
      <div class="col-sm-10">
        <input type="text" name="Mata_Pelajaran" class="form-control" id="inputPassword3" placeholder="Mata Pelajaran">
      </div>
    </div>
    <div class="form-group row">
