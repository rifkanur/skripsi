...
<head>
 ...
 <!-- //////////////////////////////////////////////////////////////////////////// -->
  ...
  <div id="top" class="clearfix">
    ...
    <!-- Start App Logo -->
    <div class="applogo">
      <a href="{{asset('admin')}}/indexguru" class="logo">M-Ujian</a>
    </div>
    <!-- End App Logo -->
...
<div class="content">
 ...
 <form>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="email" class="form-control" id="inputEmail3" placeholder="Kisi Kisi">
      </div>
    </div>
    <div class="form-group row">
      <label for="inputPassword3" class="col-sm-2 col-form-label">Mata Pelajaran</label>
      <div class="col-sm-10">
        <input type="email" class="form-control" id="inputEmail3" placeholder="Mata Pelajaran">
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <select name="" id="" class="form-control">
          <option value="">--Pilih--</option>
          <option value="">DKV 1</option>
          <option value="">DKV 2</option>
