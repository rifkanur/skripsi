...
@section('content')
    ...
    <div class="content">
        ...
        <div class="page-header">
            <h1 class="title">Data Paket Ujian</h1>
            <ol class="breadcrumb">
                <li><a href="index.html">Dashboard</a></li>
                <li><a href="#">Tables</a></li>
                <li class="active">Data Paket Ujian</li>
            </ol>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="row g-3" action="/insertJadwal" method="POST">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="Nama_Paket_Soal" class="form-control"
                                                    id="inputNanme4">
                                            </div>
                                            <div class="col-12">
                                                <label for="inputEmail4" class="form-label">Mata_Pelajaran</label>
                                                <input type="date" name="Mata_Pelajaran" class="form-control"
                                                    id="inputEmail4">
                                            </div>
                                            <div class="col-12">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting" tabindex="0" aria-controls="example0" rowspan="1"
                                            ...
                                            style="width: 170px;">Nama Paket Soal</th>
                                        <th class="sorting" tabindex="0" aria-controls="example0" rowspan="1"
                                            colspan="1" aria-label="Office: activate to sort column ascending"
                                            style="width: 170px;">Mata Pelajaran</th>
                                        <th class="sorting" tabindex="0" aria-controls="example0" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending"
                                            style="width: 150px;">Kelas</th>
                                        <th class="sorting" tabindex="0" aria-controls="example0" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending"
                                            style="width: 150px;">Jurusan</th>
